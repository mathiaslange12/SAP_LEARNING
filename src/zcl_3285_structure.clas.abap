CLASS zcl_3285_structure DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_3285_STRUCTURE IMPLEMENTATION.
...
*    DATA address TYPE st_address.
    DATA address TYPE z3285s_address.
...
*    DATA person TYPE st_person.
    DATA person TYPE z3285s_person.
...
*    DATA person2 TYPE st_person_inc.
    DATA person2    TYPE z3285s_person_inc.
