CLASS zcl_3285_check_and_fill DEFINITION PUBLIC
 FINAL
 CREATE PUBLIC.
...
CLASS ZCL_3285_CHECK_AND_FILL IMPLEMENTATION.
...
*    CONSTANTS c_version TYPE t_version VALUE lcl_generator=>with_relationships.
    ...
    CONSTANTS c_employ_table  TYPE tabname VALUE 'Z3285EMPLOY'.
    CONSTANTS c_depment_table TYPE tabname VALUE 'Z3285DEPMENT'.
