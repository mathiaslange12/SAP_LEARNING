...
define view entity Z3285_R_Employee
  as select from z3285employ as Employee
  association [1..1] to Z3285_R_DEPARTMENT as _Department on $projection.DepartmentId = _Department.Id
