CLASS zcl_3285_table_type DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_3285_table_type IMPLEMENTATION.
...
*    DATA addresses TYPE tt_addresses.
    DATA addresses TYPE z3285t_addresses.
...
*    DATA person TYPE st_person_deep.
    DATA person TYPE z3285s_person_deep.
...
*    DATA persons TYPE tt_persons.
    DATA persons    TYPE z3285t_persons.
